    ...
    <div class="px-4">
        ...
        <div class="flex flex-col gap-4 p-4">
            ...
            <div class="flex flex-wrap justify-around items-center gap-2">
                {{-- Cash on Delivery --}}
                <div class="select-none cursor-pointer text-sm hover:shadow-inner shadow bg-gray-100 rounded-xl py-2 px-3 @if ($payment_method == 1) bg-successDarker text-white shadow-inner font-bold @endif"
                    wire:click="payBy(1)">
                    {{ __('front/homePage.Cash on delivery (COD)') }}
                </div>

                {{-- Credit Card --}}
                <div class="select-none cursor-pointer text-sm hover:shadow-inner shadow bg-gray-100 rounded-xl py-2 px-3 @if ($payment_method == 2) bg-successDarker text-white shadow-inner font-bold @endif"
                    wire:click="payBy(2)">
                    {{ __('front/homePage.Credit / Debit Card') }}
                </div>

                {{-- installment --}}
                <div class="select-none cursor-pointer text-sm hover:shadow-inner shadow bg-gray-100 rounded-xl py-2 px-3 @if ($payment_method == 3) bg-successDarker text-white shadow-inner font-bold @endif"
                    wire:click="payBy(3)">
                    {{ __('front/homePage.Installment') }}
                </div>

                {{-- Vodafone Cash --}}
                <div class="select-none cursor-pointer text-sm hover:shadow-inner shadow bg-gray-100 rounded-xl py-2 px-3 @if ($payment_method == 4) bg-successDarker text-white shadow-inner font-bold @endif"
                    wire:click="payBy(4)">
