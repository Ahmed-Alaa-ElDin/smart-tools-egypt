            ...
            <div class="w-100 flex justify-between items-center gap-3">
                ...
                <div>
                    ...
                    @else
                        ...
                        @elseif ($step >= 2)
                            @if ($delivery_price == 'select default address')
                                <span class="text-xs text-danger">
                                    {{ __('front/homePage.select default address') }}
                                </span>
                            @elseif ($delivery_price == null)
                                <span class="text-xs text-danger">
            ...
            @if ($coupon_points && $coupon_points != $total_points)
                <div class="flex flex-col gap-2">
                    <del class="flex rtl:flex-row-reverse gap-1 text-successDark">
                        ...
                        <span class="font-bold text-2xl" dir="ltr">{{ number_format($total_points,0,'.','\'') }}</span>
                    </del>
                    <div class="flex rtl:flex-row-reverse gap-1 text-successDark">
                        ...
                        <span class="font-bold text-2xl" dir="ltr">{{ number_format($coupon_points,0,'.','\'') }}</span>
                    </div>
                </div>
            @else
                <div class="flex rtl:flex-row-reverse gap-1 text-successDark">
