                ...
                <div class="grid grid-cols-12 gap-x-6 gap-y-2 items-center bg-gray-100 p-2 rounded text-center my-2">
                    ...
                    <div class="col-span-6 md:col-span-5">
                        <input
                            ...
                            type="text" wire:model.lazy="f_name.ar" dir="rtl"
                    ...
                    <div class="col-span-6 md:col-span-5 ">
                        <input
                            ...
                            type="text" wire:model.lazy="f_name.en" dir="ltr"
                    ...
                    <div class="col-span-6 md:col-span-5 ">
                        <input
                            ...
                            type="text" wire:model.lazy="l_name.ar" dir="rtl"
                    ...
                    <div class="col-span-6 md:col-span-5 ">
                        <input
                            ...
                            type="text" wire:model.lazy="l_name.en" dir="ltr"
                        ...
                        @foreach ($phones as $index => $phone)
                            ...
                            <div class="col-span-1  flex flex-column justify-center items-center gap-1">
                                ...
                                <input type="radio" id="defaultPhone{{ $index }}"
                                    wire:model.lazy="defaultPhone" value="{{ $index }}"
                        ...
                        @foreach ($addresses as $index => $address)
                            <div class="bg-red-200 rounded col-span-3 grid grid-cols-3 gap-x-4 gap-y-2 p-2 ">
                                ...
                                <div class="special_marque col-span-3 grid grid-cols-6 justify-between items-center">
                                    <label
                                        class="col-span-2 lg:col-span-1 select-none cursor-pointer text-black font-medium m-0 mx-3"
                                        for="special_marque{{ $index }}">{{ __('front/homePage.Special Marque') }}</label>
