                            ...
                            <div
                                ...
                                href="{{ route('front.collections.show', ['id' => $wishlist_item->id, 'slug' => $wishlist_item->options->slug]) }}" @endif
                                    ...
                                    @if ($wishlist_item->options->thumbnail)
                                        <img @if ($wishlist_item->options->type == 'Product') src="{{ asset('storage/images/products/cropped100/' . $wishlist_item->options->thumbnail->file_name) }}"
                                        @elseif ($wishlist_item->options->type == 'Collection')
                                        src="{{ asset('storage/images/collections/cropped100/' . $wishlist_item->options->thumbnail->file_name) }}" @endif
            ...
            @if ($wishlist_count > 0)
                ...
                <div class="flex flex-col justify-center items-center gap-1 m-1 px-2">
                    <div class="flex justify-center items-center gap-3 w-full">
                        ...
                        <a href="{{ route('front.wishlist') }}" class="grow btn bg-primary btn-sm text-white font-bold">
                            <span class="material-icons">
                                visibility
                            </span>
                            &nbsp;
