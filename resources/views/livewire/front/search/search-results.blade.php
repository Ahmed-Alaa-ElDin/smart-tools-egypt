<div class="grid grid-cols-12 gap-4 p-3 items-start">
    ...
    <div id="mobile-filter-drawer"
        ...
        <button type="button" data-drawer-hide="mobile-filter-drawer" aria-controls="mobile-filter-drawer"
    ...
    <div class="col-span-12 md:col-span-9 grid grid-cols-1 gap-2">
        <div class="w-full bg-white rounded shadow m-auto px-3">
            <div class="flex justify-around items-center">
                ...
                <button
                    class="text-white bg-primary hover:bg-primaryDark focus:ring-0 font-bold rounded-lg text-xs px-3 py-2 md:hidden"
                    type="button" data-drawer-target="mobile-filter-drawer"
                    data-drawer-toggle="mobile-filter-drawer" aria-controls="mobile-filter-drawer">
                    {{ __('front/homePage.Filters') }}
                </button>
