        ...
        <aside class="col-span-3 hidden lg:block z-10 h-64 shadow">
            ...
            <ul class="bg-white rounded-b">
                ...
                <li class="group" data-id="1">
                    ...
                    <div
                        class="group-hover:block hidden hover:block absolute w-75 bg-white h-full top-0 rtl:left-0 ltr:right-0 rounded shadow-lg p-4 loaded overflow-y-scroll scrollbar scrollbar-thin scrollbar-thumb-gray-100 scrollbar-track-white">
                        <div class="card-columns ">
