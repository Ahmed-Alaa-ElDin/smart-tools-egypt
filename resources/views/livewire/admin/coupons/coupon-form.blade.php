        ...
        <div class="col-span-12 md:col-span-5 grid grid-cols-3 gap-x-4 gap-y-2 items-center w-full">
            ...
            <div class="col-span-3">
                <input id="code"
                    ...
                    type="text" wire:model.live.blur="code" placeholder="{{ __('admin/offersPages.Enter Code') }}"
        ...
        <div class="col-span-6 md:col-span-2 grid grid-cols-3 gap-x-4 gap-y-2 items-center w-full">
            ...
            <div class="col-span-3">
                <input id="number"
                    ...
                    type="text" wire:model.live.blur="number" placeholder="{{ __('admin/offersPages.Unlimited') }}">
    ...
    <div class="col-span-12 w-full flex flex-wrap mt-2 justify-around">
        ...
        @else
            ...
            <button type="button" wire:click.prevent="save('true')"
                class="bg-success hover:bg-successDark text-white font-bold py-2 px-4 rounded-xl shadow btn btn-sm">{{ __('admin/offersPages.Save and Add New Coupon') }}</button>
        @endif
        {{-- Back --}}
