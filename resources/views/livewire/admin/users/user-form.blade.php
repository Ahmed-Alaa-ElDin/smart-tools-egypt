        ...
        <div class="grid grid-cols-12 gap-x-6 gap-y-2 items-center bg-red-100 p-2 rounded text-center my-2">
            ...
            <div class="col-span-6 md:col-span-5">
                <input
                    ...
                    type="text" wire:model.live.blur="f_name.ar" placeholder="{{ __('admin/usersPages.in Arabic') }}" dir="ltr"
                    tabindex="1" required>
                @error('f_name.ar')
            ...
            <div class="col-span-6 md:col-span-5 ">
                <input
                    ...
                    type="text" wire:model.live.blur="f_name.en" placeholder="{{ __('admin/usersPages.in English') }}" dir="ltr"
                    tabindex="3">
                @error('f_name.en')
                    <div class="inline-block mt-2 col-span-12 bg-red-700 rounded text-white shadow px-3 py-1">
                        {{ $message }}</div>
        ...
        <div class="grid grid-cols-12 gap-x-6 gap-y-2 items-center bg-gray-100 p-2 rounded text-center">
            ...
            <div class="col-span-6 md:col-span-5 ">
                <input
                    ...
                    type="text" wire:model.live.blur="l_name.ar" placeholder="{{ __('admin/usersPages.in Arabic') }}" dir="ltr"
                    tabindex="2" required>
                @error('l_name.ar')
                    <div class="inline-block mt-2 col-span-12 bg-red-700 rounded text-white shadow px-3 py-1">
                        {{ $message }}</div>
            ...
            <div class="col-span-6 md:col-span-5 ">
                <input
                    ...
                    type="text" wire:model.live.blur="l_name.en" placeholder="{{ __('admin/usersPages.in English') }}" dir="ltr"
                    tabindex="4">
                @error('l_name.en')
                    <div class="inline-block mt-2 col-span-12 bg-red-700 rounded text-white shadow px-3 py-1">
                        {{ $message }}</div>
                ...
                <div
                    ...
                    <div class="col-span-2">
                        <select
                            ...
                            wire:model.live.blur="role" id="role" tabindex="8">
        ...
        <div class="col-span-12 w-full flex mt-2 justify-around">
            ...
            @else
                ...
                <button type="button" wire:click.prevent="save('true')"
                    class="bg-success hover:bg-successDark text-white font-bold py-2 px-4 rounded-xl shadow btn btn-sm">{{ __('admin/usersPages.Save and Add New User') }}</button>
            @endif
            {{-- Back --}}
