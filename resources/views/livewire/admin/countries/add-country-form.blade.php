<div>
    ...
    <div class="flex flex-wrap gap-3 justify-around mt-4">
        ...
        <button type="button" wire:click.prevent="save(true)"
            class="bg-success hover:bg-successDark text-white font-bold py-2 px-4 rounded-xl shadow btn btn-sm">{{ __('admin/deliveriesPages.Save and Add New Country') }}</button>
        {{-- Back --}}
