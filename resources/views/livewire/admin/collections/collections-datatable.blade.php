                ...
                <div class="form-inline col-span-1 justify-center">
                    <div class="flex justify-center">
                        <button class="btn btn-success dropdown-toggle btn-round btn-sm text-white font-bold "
                            ...
                            <span class="material-icons">
                                file_download
                            </span> &nbsp; {{ __('admin/productsPages.Export Collections') }}
                            &nbsp;</button>
                        <div class="dropdown-menu">
                            <a href="{{ route('admin.collections.exportExcel') }}"
                            ...
                            <a href="{{ route('admin.collections.exportPDF') }}"
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-2 max-w-min whitespace-nowrap overflow-hidden">
                                        <div class="flex items-center content-center">
                                            <input type="checkbox" wire:model="selectedCollections"
                                                value="{{ $collection->id }}"
                                    ...
                                    <td class="px-6 py-2 whitespace-nowrap text-center text-sm font-medium">
                                        ...
                                        {{-- Collection Details --}}
                                        {{-- todo --}}
                                        <a {{-- href="{{ route('front.collection.show', ['id' => $collection->id, 'slug' => $collection->slug]) }}" --}} title="{{ __('admin/productsPages.View') }}"
                                            class="m-0">
                                            <span
                                        ...
                                        {{-- Edit Button --}}
                                        <a href="{{ route('admin.collections.edit', ['collection' => $collection->id]) }}"
