                ...
                <div class="col-span-12 sm:col-span-12 grid grid-cols-12 gap-x-4 gap-y-2 items-center w-full"
                    ...
                    <div class="col-span-12 md:col-span-10">
                        <select
                            ...
                            wire:model="category_id" id="category_id" required wire:key="category_id">
                            @if ($categories->count())
                                <option value="">
    ...
    <div class="col-span-12 w-full flex flex-wrap mt-2 justify-around">
        ...
        @else
            ...
            <button type="button" wire:click.prevent="save('true')"
                class="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded-xl shadow btn btn-sm">{{ __('admin/productsPages.Save and Add New Subcategory') }}</button>
        @endif
        {{-- Back --}}
