            ...
            <div class="col-span-12 grid grid-cols-12 gap-x-4 gap-y-2 items-center w-full">
                    ...
                    <div class="col-span-12 grid grid-cols-1 gap-3 items-center w-full">
                        <div class="text-center flex flex-wrap gap-3 justify-around">
                            <div class="relative w-25">
                                ...
                                <img src="{{ asset('storage/images/subcategories/original/' . $image_name) }}"
                ...
                @else
                    ...
                    <input
                        ...
                        id="image" type="file" type="image" wire:model.live.blur="image">
            ...
            <div class="col-span-12 sm:col-span-12 grid grid-cols-12 gap-x-4 gap-y-2 items-center w-full"
                ...
                <div class="col-span-12 md:col-span-10">
                    <select
                        ...
                        wire:model.live.blur="supercategory_id" id="supercategory_id" required>
            ...
            @if ($supercategory_id)
                <div class="col-span-12 sm:col-span-12 grid grid-cols-12 gap-x-4 gap-y-2 items-center w-full"
                    ...
                    <label for="category_id"
                        class="col-span-12 md:col-span-2 select-none cursor-pointer m-0 font-bold text-xs text-gray-700">{{ __('admin/productsPages.Category') }}</label>
                    <div class="col-span-12 md:col-span-10">
                        <select
                            class="rounded w-full cursor-pointer py-1 text-center border-red-300 focus:outline-red-600 focus:ring-red-300 focus:border-red-300 @error('category_id') border-red-900 border-2 @enderror"
                            wire:model.live="category_id" id="category_id" required wire:key="category_id">
                            @if ($categories->count())
                                <option value="">
        ...
        <div class="grid grid-cols-3 gap-x-6 gap-y-2 items-center bg-gray-100 p-4 text-center  rounded shadow">
            ...
            <div class="col-span-3 w-full grid grid-cols-12 gap-x-4 gap-y-2 items-center rounded text-center">
                <label for="seo_description"
                    class="col-span-12 sm:col-span-2 md:col-start-3 lg:col-span-12 lg:col-start-1 font-bold m-0 text-center font-bold text-xs text-gray-700 cursor-pointer">{{ __("admin/productsPages.Subcategory's Description") }}</label>
    ...
    <div class="col-span-12 w-full flex flex-wrap mt-2 justify-around">
        ...
        @else
            ...
            <button type="button" wire:click.prevent="save('true')"
                class="bg-success hover:bg-successDark text-white font-bold py-2 px-4 rounded-xl shadow btn btn-sm">{{ __('admin/productsPages.Save and Add New Subcategory') }}</button>
        @endif
        {{-- Back --}}
