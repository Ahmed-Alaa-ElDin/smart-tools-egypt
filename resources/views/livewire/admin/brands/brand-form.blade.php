    ...
    <div class="col-span-12 w-full flex mt-2 justify-around">
        ...
        @else
            ...
            <button type="button" wire:click.prevent="save('true')"
                class="bg-success hover:bg-successDark text-white font-bold py-2 px-4 rounded-xl shadow btn btn-sm">{{ __('admin/productsPages.Save and Add New Brand') }}</button>
        @endif
        {{-- Back --}}
