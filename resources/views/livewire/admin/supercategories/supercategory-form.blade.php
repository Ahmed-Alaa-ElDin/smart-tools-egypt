    ...
    <div class="col-span-12 w-full flex flex-wrap mt-2 justify-around">
        ...
        @else
            ...
            <button type="button" wire:click.prevent="save('true')"
                class="bg-success hover:bg-green-700 text-white font-bold py-2 px-4 rounded-xl shadow btn btn-sm">{{ __('admin/productsPages.Save and Add New Supercategory') }}</button>
        @endif
        {{-- Back --}}
