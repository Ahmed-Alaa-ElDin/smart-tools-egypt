<div class="flex flex-col gap-3">
    ...
    <div class="">
        @if ($type == 0)
            ...
            @enderror
            {{-- Products List : Start --}}
            @livewire('admin.setting.homepage.sections.products-list-form', ['items' => $selected_products ?? []])
            {{-- Products List : End --}}
        ...
        @elseif ($type == 3)
            ...
            @enderror
            {{-- Offers List : Start --}}
            @livewire('admin.setting.homepage.sections.banners-list-form', ['banners' => $selected_banners ?? []])
            {{-- Offers List : End --}}
        @endif
    </div>
