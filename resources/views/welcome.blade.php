...
<head>
    ...
    <title>{{ $titlePage ?? 'sdasd' . ' | ' . __('Smart Tools Egypt') }}</title>
                    ...
                    <div class="p-6">
                        ...
                        <div class="ml-12">
                            <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                                ...
                                </div>                                Laravel has wonderful, thorough documentation covering every aspect of the framework.
            ...
            window.addEventListener('swalConfirm', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.dispatch(e.detail.method, e.detail.id, e.detail.details || []);
                    }
                });
            });
