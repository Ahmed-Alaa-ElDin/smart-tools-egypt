@extends('layouts.front.site', [
    'titlePage' => __('front/homePage.Return and Exchange Policy'),
    'url' => route('front.policies.return-and-exchange'),
    'title' => __('front/homePage.Return and Exchange Policy'),
    'description' => '',
])
    ...
    <div class="container px-4 py-2 ">
        ...
        <nav aria-label="breadcrumb" role="navigation" class="mb-2">
            <ol class="breadcrumb text-sm">
                ...
                {{ __('front/homePage.Return and Exchange Policy') }}
                </li>
            </ol>
        </nav>
        {{-- Breadcrumb :: End --}}
