...
@section('sub-content')
                ...
                <div class="bg-white rounded-xl overflow-hidden">
                    ...
                    <div class="p-7 flex flex-col justify-center items-center gap-3">
                        ...
                        @forelse ($orders as $order)
                            @if (!in_array($order->status_id, [201, 7, 15]))
                                {{-- Order :: Start --}}
                                    ...
                                    <div
                                        ...
                                        <div>
                                            <div class="flex flex-wrap justify-around items-center gap-1">
                                                ...
                                                {{-- Go To Paymob Iframe --}}
                                                {{-- @if ($order->status_id == 203 && ($order->payment_method == 2 || $order->payment_method == 3)) --}}
                                                ...
                                                {{-- @elseif ($order->status_id == 203 && $order->payment_method == 4)
                                                ...
                                                {{-- Track Order --}}
                                                {{-- @if (!in_array($order->status_id, [201, 202, 9]))
    ...
    !in_array($order->status_id, [8, 9, 7, 17, 18, 19]))
