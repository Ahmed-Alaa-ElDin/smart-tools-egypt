                                ...
                                <div class="rounded overflow-hidden shadow-lg border border-gray-200 w-full">
                                    ...
                                    <div
                                        ...
                                        <div class="flex justify-start items-center gap-4">
                                            ...
                                            <div class="flex flex-col justify-center items-center gap-1 min-w-max">
                                                <span
                                                    class="text-xs py-1 px-2 shadow-inner rounded-xl font-bold {{ in_array($order->status_id, [1, 2, 10, 11])
                                                        ? 'bg-yellow-100 text-yellow-900'
                                                        : (in_array($order->status_id, [3, 7, 12])
                                        ...
                                        <div>
                                            ...
                                            <div class="flex flex-wrap justify-around items-center gap-1">
                                                ...
                                                @if (auth()->user()->invoiceRequests->where('order_id', $order->id)->count() == 0 && !in_array($order->status_id, [8, 9]))
