            ...
            @forelse ($supercategories as $supercategory)
                ...
                <div
                    ...
                    <div class="flex flex-col gap-2 my-2 items-center justify-center">
                        ...
                        <a href="{{ route('front.supercategory.subcategories',['supercategory_id'=>$supercategory->id]) }}" class="text-center rounded-full bg-primaryDark text-white px-2 py-1 shadow text-sm font-bold">
                        ...
                        {{-- Products No :: Start --}}
                        <a href="{{ route('front.supercategory.products',['supercategory_id'=>$supercategory->id]) }}" class="text-center rounded-full bg-primary text-white px-2 py-1 shadow text-sm font-bold">
