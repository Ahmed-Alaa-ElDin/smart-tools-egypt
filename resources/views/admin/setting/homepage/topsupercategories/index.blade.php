                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header card-header-primary">
                            <div class="flex justify-between items-center">
                                <div class=" ltr:text-left rtl:text-right font-bold self-center text-gray-100">
                                    <p class="">
                                        {{ __("admin/sitePages.Here you can manage homepage's top supercategories") }}
                                    </p>
                                </div>
                                ...
                                <div class="ltr:text-right rtl:text-left">
                                    <a href="{{ route('admin.supercategories.create') }}"
                                        ...
                                        {{ __('admin/sitePages.Add Supercategory') }}
                                    </a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body overflow-hidden">
                            ...
                            {{-- Datatable Start --}}
                            @livewire('admin.setting.homepage.topsupercategories.top-super-categories')
                            {{-- Datatable End --}}
