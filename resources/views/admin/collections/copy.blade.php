@extends('layouts.admin.admin', ['activeSection' => 'Collections', 'activePage' => '', 'titlePage' => __('admin/productsPages.Copy Collection')])
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb text-sm">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ __('admin/productsPages.Copy Collection') }}
                    </li>
                </ol>
            </nav>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header card-header-primary">
                            <div class="row">
                                <div class="col-12 ltr:text-left rtl:text-right font-bold self-center text-gray-100">
                                    <p class="">
                                        {{ __("admin/productsPages.Through this form you can copy collections' data") }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body overflow-hidden">
                            ...
                            {{-- Form Start --}}
                            @livewire('admin.collections.collection-form', ['old_collection_id' => $old_collection_id])
