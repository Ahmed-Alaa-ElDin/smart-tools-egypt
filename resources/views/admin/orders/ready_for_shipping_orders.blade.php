@extends('layouts.admin.admin', ['activeSection' => 'Orders', 'activePage' => 'Ready for Shipping Orders', 'titlePage' => __('admin/ordersPages.Ready for Shipping Orders')])
        ...
        <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb text-sm">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('admin/ordersPages.Ready for Shipping Orders') }}</li>
                </ol>
            </nav>
                    ...
                    <div class="card">
                        ...
                        <div class="card-header card-header-primary">
                            <div class="flex justify-between">
                                <div class=" ltr:text-left rtl:text-right font-bold self-center text-gray-100">
                                    <p class=""> {{ __('admin/ordersPages.Here you can manage ready for shipping orders') }}</p>
                                </div>
                        ...
                        <div class="card-body overflow-hidden">
                            ...
                            @livewire('admin.orders.orders-datatable',[
                                'type' => 'ready_for_shipping_orders'
                            ])
                            {{-- Datatable End --}}
                        </div>
                    </div>
