@extends('layouts.admin.admin', ['activeSection' => 'Orders', 'activePage' => 'Uncompleted Orders', 'titlePage' => __('admin/ordersPages.Uncompleted Orders')])
...
@section('content')
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb text-sm">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">
                        {{ __('admin/ordersPages.Uncompleted Orders') }}
                    </li>
                </ol>
            </nav>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header card-header-primary">
                            <div class="flex justify-between">
                                <div class=" ltr:text-left rtl:text-right font-bold self-center text-gray-100">
                                    <p class="">
                                        {{ __('admin/ordersPages.Here you can control uncompleted orders') }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body overflow-hidden">
                            {{-- Datatable Start --}}
                            @livewire('admin.orders.uncompleted-orders-datatable')
                            {{-- Datatable End --}}
                        </div>
                    </div>
                </div>
    ...
    {{-- Cart Content Modal --}}
    @livewire('admin.carts.cart-content-modal')
    {{-- Cart Content Modal --}}
