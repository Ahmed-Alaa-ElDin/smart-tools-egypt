@extends('layouts.admin.admin', ['activeSection' => 'Orders', 'activePage' => 'Suspended Orders', 'titlePage' => __('admin/ordersPages.Suspended Orders')])
        ...
        <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb text-sm">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('admin/ordersPages.Suspended Orders') }}</li>
                </ol>
            </nav>
                        ...
                        <div class="card-header card-header-primary">
                            <div class="flex justify-between">
                                <div class=" ltr:text-left rtl:text-right font-bold self-center text-gray-100">
                                    <p class=""> {{ __('admin/ordersPages.Here you can manage suspended orders') }}</p>
                                </div>
