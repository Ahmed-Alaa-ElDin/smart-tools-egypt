...
=> __("admin/productsPages.'s Subcategories",['name'=>$supercategory->name])])
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body overflow-hidden">
                            {{-- Datatable Start --}}
                            @livewire('admin.subcategories.subcategories-datatable',['search' => $supercategory->name])
                            {{-- Datatable End --}}
                        </div>
                    </div>
                </div>
