        ...
        <div class="container-fluid">
            ...
            <nav aria-label="breadcrumb" role="navigation">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">{{ __('admin/usersPages.Add Role') }}
                    </li>
                </ol>
            </nav>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header card-header-primary">
                            <div class="row">
                                <div class="col-12 ltr:text-left rtl:text-right font-bold self-center text-gray-100">
                                    <p class="">
                                        {{ __('admin/usersPages.Through this form you can add new role') }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body overflow-hidden">
                            ...
                            {{-- Form Start --}}
                            @livewire('admin.roles.add-role-form')
                            {{-- content --}}
