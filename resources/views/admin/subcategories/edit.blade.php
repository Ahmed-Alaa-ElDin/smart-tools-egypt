...
=> __('admin/productsPages.Edit Subcategory')])
                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header card-header-primary">
                            <div class="row">
                                <div class="col-12 ltr:text-left rtl:text-right font-bold self-center text-gray-100">
                                    <p class="">
                                        {{ __("admin/productsPages.Through this form you can edit subcategory's data") }}
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card-body overflow-hidden">
                            ...
                            {{-- Form Start --}}
                            @livewire('admin.subcategories.subcategory-form', ['subcategory_id' => $subcategory])
