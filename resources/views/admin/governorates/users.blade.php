                ...
                <div class="col-md-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header card-header-primary">
                            <div class="flex justify-between">
                                <div class=" ltr:text-left rtl:text-right font-bold self-center text-gray-100">
                                    <p class="">
                                        {{ __("admin/deliveriesPages.Here you can manage governorate's users") }}</p>
                                </div>
                        ...
                        <div class="card-body overflow-hidden">
                            {{-- Data Table Start --}}
                            @livewire('admin.governorates.users-governorate-datatable' , ['governorate_id' => $governorate->id])
                            {{-- Data Table End --}}
                        </div>
                    </div>
                </div>
