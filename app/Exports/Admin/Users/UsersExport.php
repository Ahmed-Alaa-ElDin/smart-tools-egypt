...
class UsersExport implements FromCollection, WithHeadings, WithStyles, WithMapping, ShouldAutoSize, WithEvents
{
    ...
    public function map($user): array
    {
        return [
            ...
            $user->addresses->first()? $user->addresses->first()->governorate->getTranslation('name','en') : __('N/A'),
            $user->addresses->first()? $user->addresses->first()->governorate->getTranslation('name','ar') : __('N/A'),
