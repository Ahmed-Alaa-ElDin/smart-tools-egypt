...
class DeletedCollectionsDatatable extends Component
{
    ...
    public function deleteConfirm($collection_id)
    {
        $this->dispatchBrowserEvent('swalConfirm', [
            "text" => __('admin/productsPages.Are you sure, you want to permanently delete this collection ?'),
    ...
    public function forceDeleteCollection($collection_id)
    {
        try {
            $collection = Collection::withTrashed()->findOrFail($collection_id);
            $collection->forceDelete();

            $this->dispatchBrowserEvent('swalDone', [
                "text" => __('admin/productsPages.Collection has been deleted permanently successfully'),
                'icon' => 'success'
            ]);
            ...
            $this->dispatchBrowserEvent('swalDone', [
                "text" => __("admin/productsPages.Collection hasn't been deleted permanently"),
                'icon' => 'error'
            ]);
        }
    }
    ...
    {
        $this->dispatchBrowserEvent('swalConfirm', [
            "text" => __('admin/productsPages.Are you sure, you want to restore this collection ?'),
    ...
    public function restoreCollection($collection_id)
    {
        try {
            $collection = Collection::withTrashed()->findOrFail($collection_id);
            $collection->restore();
            ...
            $this->dispatchBrowserEvent('swalDone', [
                "text" => __('admin/productsPages.Collection has been restored successfully'),
                'icon' => 'success'
            ]);
            ...
            $this->dispatchBrowserEvent('swalDone', [
                "text" => __("admin/productsPages.Collection hasn't been restored"),
                'icon' => 'error'
            ]);
        }
    }
    ...
    {
        $this->dispatchBrowserEvent('swalConfirm', [
            "text" => __('admin/productsPages.Are you sure, you want to delete all selected collections permanently?'),
            'confirmButtonText' => __('admin/productsPages.Delete'),
            'denyButtonText' => __('admin/productsPages.Cancel'),
            'denyButtonColor' => 'green',
            'confirmButtonColor' => 'red',
    ...
    public function forceDeleteAllCollection()
    {
        try {
            ...
            $this->dispatchBrowserEvent('swalDone', [
                "text" => __('admin/productsPages.Collections have been deleted permanently successfully'),
                'icon' => 'success'
            ]);
            ...
            $this->dispatchBrowserEvent('swalDone', [
                "text" => __("admin/productsPages.Collections haven't been deleted permanently"),
                'icon' => 'error'
            ]);
        }
    }
    ...
    {
        $this->dispatchBrowserEvent('swalConfirm', [
            "text" => __('admin/productsPages.Are you sure, you want to restore all selected collections?'),
            'confirmButtonText' => __('admin/productsPages.Restore'),
            'denyButtonText' => __('admin/productsPages.Cancel'),
            'denyButtonColor' => 'red',
            'confirmButtonColor' => 'green',
    ...
    public function restoreAllCollection()
    {
        try {
            ...
            $this->dispatchBrowserEvent('swalDone', [
                "text" => __('admin/productsPages.Collections have been restored successfully'),
                'icon' => 'success'
            ]);
            ...
            $this->dispatchBrowserEvent('swalDone', [
                "text" => __("admin/productsPages.Collections haven't been restored"),
                'icon' => 'error'
            ]);
        }
    }
