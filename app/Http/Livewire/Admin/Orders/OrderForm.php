...
class OrderForm extends Component
{
    ...
    public function getOrderData($make_order = false)
    {
        ...
        $this->emitTo('admin.orders.new-order-user-part', 'getUserData');
    }
    ...
    public function setUserData($data)
    {
        ...
        $this->emitTo('admin.orders.new-order-products-part', 'getProductsData');
    }
    ...
    public function setProductsData($data)
    {
        ...
        $this->emitTo('admin.orders.new-order-payment-part', 'getPaymentData');
    }
    ...
    public function setPaymentData($data)
    {
        ...
        if ($this->make_order) {
            if ($this->total_after_wallet < 0 || $this->total < 0) {
                $this->dispatchBrowserEvent('displayOrderSummary');
            } else {
                $this->makeOrder();
            }
        } else {
