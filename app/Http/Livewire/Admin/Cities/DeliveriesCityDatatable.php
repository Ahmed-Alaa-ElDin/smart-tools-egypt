...
class DeliveriesCityDatatable extends Component
{
    use WithPagination;
    ...
    {
        $deliveries = City::with('deliveries')->findOrFail($this->city_id)
        ...
        return view('livewire.admin.cities.deliveries-city-datatable', compact('deliveries'));
    }
