...
class DeletedProductsDatatable extends Component
{
    ...
    {
        $this->dispatch('swalConfirm', text: __('admin/productsPages.Are you sure, you want to permanently delete this product ?'),
    ...
    public function forceDeleteProduct($id)
    {
        try {
            ...
            $this->dispatch('swalDone', text: __('admin/productsPages.Product has been deleted permanently successfully'),
                icon: 'success');
    ...
    {
        $this->dispatch('swalConfirm', text: __('admin/productsPages.Are you sure, you want to restore this product ?'),
    ...
    public function restoreProduct($id)
    {
        try {
            ...
            $this->dispatch('swalDone', text: __('admin/productsPages.Product has been restored successfully'),
                icon: 'success');
    ...
    {
        $this->dispatch('swalConfirm', text: __('admin/productsPages.Are you sure, you want to delete all selected products permanently?'),
            confirmButtonText: __('admin/productsPages.Delete'),
            denyButtonText: __('admin/productsPages.Cancel'),
            denyButtonColor: 'green',
            confirmButtonColor: 'red',
    ...
    public function forceDeleteAllProduct()
    {
        try {
            ...
            $this->dispatch('swalDone', text: __('admin/productsPages.Products have been deleted permanently successfully'),
                icon: 'success');

            $this->selectedProducts = [];
        } catch (\Throwable $th) {
            $this->dispatch('swalDone', text: __("admin/productsPages.Products haven't been deleted permanently"),
                icon: 'error');
        }
    }
    ######## Force Delete All Selected Products #########
    ...
    {
        $this->dispatch('swalConfirm', text: __('admin/productsPages.Are you sure, you want to restore all selected products?'),
            confirmButtonText: __('admin/productsPages.Restore'),
            denyButtonText: __('admin/productsPages.Cancel'),
            denyButtonColor: 'red',
            confirmButtonColor: 'green',
    ...
    public function restoreAllProduct()
    {
        try {
            ...
            $this->dispatch('swalDone', text: __('admin/productsPages.Products have been restored successfully'),
                icon: 'success');

            $this->selectedProducts = [];
        } catch (\Throwable $th) {
            $this->dispatch('swalDone', text: __("admin/productsPages.Products haven't been restored"),
                icon: 'error');
        }
    }
    ######## Restore All Selected Products #########
    ...
    {
        $this->dispatch('swalConfirm', text: __('admin/productsPages.Are you sure, you want to publish all selected products ?'),
    ...
    public function publishAllProduct()
    {
        ...
        try {
            ...
            $this->dispatch('swalDone', text: __('admin/productsPages.Products have been published'),
                icon: 'success');

            $this->selectedProducts = [];
        } catch (\Throwable $th) {
            $this->dispatch('swalDone', text: __("admin/productsPages.Products haven't been published"),
                icon: 'error');
        }
    }
    ######## Publish All Selected Products #########
    ...
    {
        $this->dispatch('swalConfirm', text: __('admin/productsPages.Are you sure, you want to hide all selected products ?'),
    ...
    public function hideAllProduct()
    {
        ...
        try {
            ...
            $this->dispatch('swalDone', text: __('admin/productsPages.Products have been hidden'),
                icon: 'success');

            $this->selectedProducts = [];
        } catch (\Throwable $th) {
            $this->dispatch('swalDone', text: __("admin/productsPages.Products haven't been hidden"),
                icon: 'error');
        }
    }
    ######## Hide All Selected Products #########
