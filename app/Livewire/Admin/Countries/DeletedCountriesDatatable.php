...
class DeletedCountriesDatatable extends Component
{
    ...
    {
        $this->dispatch('swalConfirm', text: __('admin/deliveriesPages.Are you sure, you want to delete this country permanently ?'),
    ...
    {
        $this->dispatch('swalConfirm', text: __('admin/deliveriesPages.Are you sure, you want to restore this country ?'),
    ...
    {
        $this->dispatch('swalConfirm', text: __('admin/deliveriesPages.Are you sure, you want to delete all countries permanently ?'),
            confirmButtonText: __('admin/deliveriesPages.Delete'),
            denyButtonText: __('admin/deliveriesPages.Cancel'),
            denyButtonColor: 'green',
            confirmButtonColor: 'red',
    ...
    public function forceDeleteAllCountries()
    {
        try {
            ...
            $this->dispatch('swalDone', text: __('admin/deliveriesPages.All countries have been deleted successfully'),
                icon: 'info');
        } catch (\Throwable $th) {
            $this->dispatch('swalDone', text: __('admin/deliveriesPages.All countries haven\'t been deleted'),
                icon: 'error');
        }
    }
    ######## Force Delete All #########
    ...
    {
        $this->dispatch('swalConfirm', text: __('admin/deliveriesPages.Are you sure, you want to restore all countries ?'),
            confirmButtonText: __('admin/deliveriesPages.Confirm'),
            denyButtonText: __('admin/deliveriesPages.Cancel'),
            denyButtonColor: 'red',
            confirmButtonColor: 'green',
    ...
    public function restoreAllCountries()
    {
        try {
            ...
            $this->dispatch('swalDone', text: __('admin/deliveriesPages.All countries have been restored successfully'),
                icon: 'success');
        } catch (\Throwable $th) {
            $this->dispatch('swalDone', text: __('admin/deliveriesPages.All countries haven\'t been restored'),
                icon: 'error');
        }
    }
    ######## Restore All #########
